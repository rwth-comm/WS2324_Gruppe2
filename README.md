...
-   **Feedback JRH:** In der ersten Unterschiedshypothese handelt es
    sich um einen unverbundenen T-Test, nicht um einen einfachen. Die
    dritte Hypothese ist nicht ganz präzise. Meinen Sie vielleicht, dass
    sich das Bedrohungsempfinden zwischen den beiden Gruppen
    unterscheidet?
...
-   **Feedback JRH:** Sehr gut! Passt sehr gut zu ihrer ersten
    Zusammenhangshypothese, da für die MANCOVA die beiden AVs
    korrelieren müssen. Sehr schön :-) Bitte den Begriff
    “Mehrfachauswahl” bei der Operationalisierung nochmal überdenken.
